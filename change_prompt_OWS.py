...
with open("./template/OWS.md", "w", encoding="utf-8") as f:
...
with open("OWS_kg_prompt.md", "w", encoding="utf-8") as f:
...
json.dump(APPLICATION_PROMPTS, open("./graph_utils/chatgpt/config/prompts_config_OWS.json", "w"), ensure_ascii=False, indent=2)
