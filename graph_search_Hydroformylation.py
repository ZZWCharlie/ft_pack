...
def group_pdf_files_with_si(subfolder_path):
    ...
    适用于Hydroformylation命名模式：文件名以"-SI"或"-si"结尾为补充材料，其他为主文件
...
if __name__ == "__main__":
    type_name = "Hydroformylation"  # 改为Hydroformylation
    result_path = "/home/user/shizhou/Agent/ft_pack/papersavings/"
    base_folder = "/home/user/shizhou/Agent/ft_pack/origin_paper/Hydroformylation"  # 改为Hydroformylation文件夹
    
    # 直接处理Hydroformylation文件夹中的PDF文件
