...
with open("./outline_Hydroformylation.md", "r") as f:
    outline = f.read()
    
graphllm = ChatOpenAI(temperature=0, model_name="gpt-4.1-2025-04-14")

subject_template_file = "./template/Hydroformylation.md"
subject_kg_prompt_file = "./graph_utils/Hydroformylation_kg_prompt.md"
prompts_config_file="./graph_utils/chatgpt/config/prompts_config_Hydroformylation.json"
# 加载费托合成的大提示词
...
for index, test_split in enumerate(text_splitter_markdown.split_text(new_subject_template)):
    try:
        print(test_split.metadata['Header 2'])
        count+=1
